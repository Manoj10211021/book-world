  ...
  return (
    <footer className="py-2 px-4 bg-slate-100 z-30 sm:flex items-center gap-2 border-t border-slate-200  sm:bg-white dark:bg-zinc-950 dark:border-zinc-800">
      ...
      <div className="sm:ml-auto flex items-center justify-center gap-2 ">
        ...
        <Link to="https://github.com/Manoj10211021" target="_blank">
          <Button variant="outline" size="icon">
            <FaGithub className="h-6 w-6" />
            <span className="sr-only">Github</span>
          </Button>
        </Link>
        <Link to="change the review" target="_blank">
          <Button variant="outline" size="icon">
        ...
        <Link
          to="https://www.geeksforgeeks.org/user/manoj81gw97/"
          target="_blank"
        >
          <Button variant="outline" size="icon">
        ...
        <Link to="https://www.instagram.com/mnoj.n8/" target="_blank">
          <Button variant="outline" size="icon">
